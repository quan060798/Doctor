...
//        Query queryRef = database.orderByChild("doc_name").equalTo("Maghesan");
        ...
        list = new ArrayList<>();
        myAdapter = new CustomListAdapter(this,list);
                ...
                queryRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                            ...
                            if(appointment3.getDoc_approval().equals("")) {
...
//        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.back:
                Intent intent2back = new Intent(AppointmentList.this,DoctorHomePage.class);
